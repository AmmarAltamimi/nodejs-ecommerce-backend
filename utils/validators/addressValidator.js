...
const {
  isRefBelongsToSubModel,
  valueAlreadyExistsInSubModel,
...
exports.addToAddressValidator = [
  check("alias")
    ...
    .custom(async (val, { req }) =>
      valueAlreadyExistsInSubModel(val, req, User)
    ),
  check("details")
    .notEmpty()
    .withMessage("details is required")
    .isLength({ min: 2 })
    .withMessage("too short details address ")
    .isLength({ max: 100 })
    .withMessage("too long details address "),
  check("phone")
    .notEmpty()
