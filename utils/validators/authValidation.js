...
const{valueAlreadyExists,setSlug,checkPasswordConfirm,check6DigitsResetCode} = require("./customValidator");
...
exports.verifyPassResetCodeValidator = [
    ...
    .custom(async(resetCode,{req})=> check6DigitsResetCode(resetCode,req)),
    validatorMiddleware
