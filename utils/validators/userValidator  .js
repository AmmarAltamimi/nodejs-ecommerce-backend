...
const{valueAlreadyExists,setSlug,checkPasswordConfirm,checkCurrentPassword} = require("./customValidator");
...
check("email")
.isEmail().withMessage("Invalid user email format")
.notEmpty().withMessage("user email required")
.custom((val,{req})=> valueAlreadyExists(val,req,User)),
check("phone")
.isMobilePhone(['ar-YE','ar-EG','ar-SA']).withMessage('Invalid phone number only accepted YE,Egy and SA Phone numbers'),
check("password")
...
exports.updateUserValidator = [
 ...
 exports.updateUserPasswordValidator =  [ 
    ...
    .custom(async(password,{req})=> checkPasswordConfirm(password,req))
    .custom(async(val,{req})=> checkCurrentPassword(req.body.currentPassword,req,User)),
    check("passwordConfirm")
   .notEmpty().withMessage("user password required ")
